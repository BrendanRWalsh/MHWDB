...
# json_url = urlopen('https://mhw-db.com/items')
# itemsMHWDB = json.loads(json_url.read())
# with open('weaponsMHWDB.json', 'w', encoding='utf-8') as f:
    # json.dump(weaponsMHWDB, f, ensure_ascii=False, indent=4)
